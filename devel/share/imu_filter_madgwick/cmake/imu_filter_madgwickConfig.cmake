...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/imu_tools/imu_filter_madgwick)
  set(imu_filter_madgwick_DEVEL_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/install)
...
if(NOT "/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel/include;/usr/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/imu_tools/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
