...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_imu_SOURCE_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/phidgets_drivers/phidgets_imu)
  set(phidgets_imu_DEVEL_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel)
  ...
  set(phidgets_imu_INSTALL_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/install)
...
if(NOT "/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/phidgets_drivers/phidgets_imu/include;/usr/include " STREQUAL " ")
  set(phidgets_imu_INCLUDE_DIRS "")
  set(_include_dirs "/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/phidgets_drivers/phidgets_imu/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/phidgets_drivers/phidgets_imu/${idir}'.  ${_report}")
    endif()
