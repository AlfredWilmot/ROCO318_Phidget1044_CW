...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_high_speed_encoder_SOURCE_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/phidgets_drivers/phidgets_high_speed_encoder)
  set(phidgets_high_speed_encoder_DEVEL_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel)
  ...
  set(phidgets_high_speed_encoder_INSTALL_PREFIX /home/alfie/ROCO_318/ROCO318_Phidget1044_CW/install)
...
if(NOT "/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel/include " STREQUAL " ")
  set(phidgets_high_speed_encoder_INCLUDE_DIRS "")
  set(_include_dirs "/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_high_speed_encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alfie/ROCO_318/ROCO318_Phidget1044_CW/src/phidgets_drivers/phidgets_high_speed_encoder/${idir}'.  ${_report}")
    endif()
